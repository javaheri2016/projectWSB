...
$config['item']['id']             = 'item1';    // Item id
$config['item']['name']           = 'laptop';    // Item name
$config['item']['price']          = '2568';    // Item price
$config['item']['qty']            = '1';    // Item quantity
$config['item']['url']            = '#';    // Item URL (optional)
